...
class CargoPageSchemas extends PSExtensionHandler {
	...
	public static function getFieldEditingHTML( $psField ){
		...
		$html_text .= Html::rawElement( 'select', array( 'name' => 'cargo_field_type_num' ), $selectBody ) . "\n";
		$html_text .= "<p>$allowedValuesLabel<br />\n";
		$html_text .= Html::input( 'cargo_field_allowed_values_num', $allowedValuesString, 'text', array( 'size' => 100 ) );
		$html_text .= "\t</p>\n";
